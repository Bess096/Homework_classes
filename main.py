...
student1.lecturer_ratings(lecturer1, 'Git', 8)
student2.lecturer_ratings(lecturer2, 'Go', 8)
student2.lecturer_ratings(lecturer2, 'Go', 9)
student1.lecturer_ratings(lecturer2, 'Python', 8)
student1.lecturer_ratings(lecturer2, 'Python', 6)
...
reviewer2.rate_hw(student2, 'Go', 8)
